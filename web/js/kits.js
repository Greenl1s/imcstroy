...
/**
 * Одна строка проверки. Занятый прибор и прибор без действующего срока
 * поверки заблокированы: сервер не разрешит выдать их ни отдельно,
 * ни в составе комплекта.
 */
